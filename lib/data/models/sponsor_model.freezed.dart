...
class _$SponsorModelImpl implements _SponsorModel {
  ...
  @override
  String toString() {
    return 'SponsorModel(name: $name, content: $content, isVisible: $isVisible, moyaAmount: $moyaAmount, date: $date)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, content, isVisible, moyaAmount, date);
...
abstract class _SponsorModel implements SponsorModel {
  factory _SponsorModel(
      ...
      required final int moyaAmount,
      required final String date}) = _$SponsorModelImpl;
